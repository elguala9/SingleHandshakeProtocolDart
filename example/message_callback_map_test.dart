...
void main() {
  ...
  print('IPv4 Parsed: address=${ipv4Parsed?.address}, port=${ipv4Parsed?.port}');
  ...
  print('IPv6 Parsed: address=${ipv6Parsed?.address}, port=${ipv6Parsed?.port}');
  ...
  print('IPv6 Loopback Parsed: address=${ipv6LoopbackParsed?.address}, port=${ipv6LoopbackParsed?.port}');
