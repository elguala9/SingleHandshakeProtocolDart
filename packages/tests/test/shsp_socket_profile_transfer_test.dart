...
void main() {
  group('ShspSocket Profile Transfer', () {
    ...
    test('applyProfile restores all message listeners to new socket', () async {
      ...
      expect(
        profile2.messageListeners.isEmpty,
        isTrue,
    ...
    test(
      ...
      () async {
        ...
        expect(
          profileC.messageListeners.length,
          equals(2),
        ...
        expect(
          ...
          equals(3),
          reason:
              'Applying profile B should add its listeners to existing ones',
        );
    ...
    test('empty profile can be applied without issues', () async {
      ...
      expect(
        socket.extractProfile().messageListeners.length,
        equals(1),
    ...
    test('profile persists across close and recreate', () async {
      ...
      expect(
        socket2.extractProfile().messageListeners.length,
        equals(2),
