...
void main() {
  ...
  group('HandshakeSignal', () {
    ...
    test('should handle timing calculations', () {
      ...
      final totalDuration = signal.endHandshakeAvailability.difference(signal.referenceTimestamp);
      ...
      final possibleHandshakes = availableSeconds ~/ signal.intervalBetweenHandshakesSeconds;
      expect(possibleHandshakes, equals(48)); // 8 hours * 3600 seconds / 600 seconds interval
    });
    ...
    test('should handle extreme timing values', () {
      ...
      final duration = signal.endHandshakeAvailability.difference(signal.referenceTimestamp);
