...
void main() {
  group('IShspSocket Interface - New Methods', () {
    ...
    test('ShspSocket implements applyProfile method', () async {
      ...
      expect(
        appliedProfile.messageListeners.isNotEmpty,
        isTrue,
    ...
    test('applyProfile merges callbacks', () async {
      ...
      expect(
        socket2Profile.messageListeners.isNotEmpty,
        isTrue,
    ...
    test('extractProfile from DualShspSocket merges both sockets', () async {
      ...
      final peer6 = PeerInfo(address: InternetAddress.loopbackIPv6, port: 6666);
    ...
    test(
      'applyProfile to DualShspSocket applies to both internal sockets',
      () async {
    ...
    test('extractProfile method is part of IShspSocket contract', () async {
      ...
      expect(
        ...
        isA<ShspSocketProfile>(),
        reason:
            'extractProfile should be accessible through IShspSocket interface',
      );
    ...
    test('applyProfile method is part of IShspSocket contract', () async {
      ...
      // Verify
      expect(
        socket2.extractProfile().messageListeners.isNotEmpty,
        isTrue,
        reason:
            'applyProfile should be accessible through IShspSocket interface',
      );
