...
class RegistrySingleton<Key, Value extends IValueForRegistry>
    extends RegistryManager<Key, Value> {
  /// Private constructor
  RegistrySingleton._internal() : super();

  static final RegistrySingleton<dynamic, IValueForRegistry> _instance =
      RegistrySingleton._internal();

  static RegistrySingleton<dynamic, IValueForRegistry> get instance =>
      _instance;
}
