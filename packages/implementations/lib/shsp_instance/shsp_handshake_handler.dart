...
class ShspHandshakeHandler {
  ...
  static Future<IShspInstance> handshakeInstance(IShspInstance instance, ShspHandshakeHandlerOptions options, [void Function(IShspInstance instance)? onOpen]) async{
